...
try {
    if (isset($_POST['btnRegistrar'])) {
        $usuario = new Usuario();
        $usuario->crearUsuario($_POST['cedula'], $_POST['nombres'], $_POST['apellidos'], $_POST['telefono'], $_POST['direccion'], $_POST['fechaNacimiento'], $_POST['genero'], $_POST['contrasena'], $_POST['rol'], $_POST['estado']);
        if (empty($usuario)) {
